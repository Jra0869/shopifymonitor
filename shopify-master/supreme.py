...
if(__name__ == "__main__"):
    ...
    products_list = {}
    proxies = get_proxy(proxy_list)
    discord_webhook = "https://discordapp.com/api/webhooks/532279965585113098/yivgf297mXR3B5N3Icj_IbOHCVbHxEy0MX73Mf5cKbVAIBN0s8UgSEP85IdtAHZOVsM_"  # Put your webhook here
